...
include "../classes/database.php";?>
    ...
    <p id="citat">“Osvajao sam titule, jer sam dodavao gas, tamo gde su drugi kočili!” Mihael Šumaher</p>
    <div class="slike">
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/znojnice1.jpg" alt="">
            </div>
            <div class="col-1">
                <p>Znojnice Nike</p>
            </div>
            <div class="col-3">
                <img src="../images/odeca/znojnice2.jpg" alt="">
            </div>
            <div class="col-1"><p>Znojnice Adidas</p></div>
            <div class="col-3">
                <img src="../images/odeca/znojnice3.jpg" alt="">
            </div> 
            <div class="col-1"><p>Znojnice Puma</p></div>
        </div>
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/kapa1.png" alt="">
            </div>
            <div class="col-1"><p>Kapa Srbija</p></div>
            <div class="col-3">
                <img src="../images/odeca/kapa2.png" alt="">
            </div>
            <div class="col-1"><p>Kapa Partizan</p></div>
            <div class="col-3">
                <img src="../images/odeca/kapa3.png" alt="">
            </div>
            <div class="col-1"><p>Kapa Crvena Zvezda</p></div>
        </div>
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/ranac1.png" alt="">
            </div>
            <div class="col-1"><p>Ranac Nike</p></div>
            <div class="col-3">
                <img src="../images/odeca/ranac2.png" alt="">
            </div>
            <div class="col-1"><p>Ranac Adidas</p></div>
            <div class="col-3">
                <img src="../images/odeca/ranac3.png" alt="">
            </div>
            <div class="col-1"><p>Ranac Puma</p></div>
        </div>
    </div>
    <div class="recenzije">
        <h3>Recenzije:</h3>
