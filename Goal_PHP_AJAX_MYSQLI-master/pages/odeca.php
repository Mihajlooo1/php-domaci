...
<?php include '../classes/database.php'; ?>
    ...
    <p id="citat">"Sport me je odvojio od toga da budem u bandi, ili povezan sa drogom. Sport je bio moj izlaz."
        Lebron Džejms
    </p>
    <div class="slike">
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/dres1.jpg" alt="">
            </div>
            <div class="col-1">
                <p>Dres Srbija</p>
            </div>
            <div class="col-3">
                <img src="../images/odeca/dres2.jpg" alt="">
            </div>
            <div class="col-1"><p>Dres Partizan</p></div>
            <div class="col-3">
                <img src="../images/odeca/dres3.jpg" alt="">
            </div> 
            <div class="col-1"><p>Dres Crvena Zvezda</p></div>
        </div>
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/sorc1.jpg" alt="">
            </div>
            <div class="col-1"><p>Sorc Srbija</p></div>
            <div class="col-3">
                <img src="../images/odeca/sorc2.jpg" alt="">
            </div>
            <div class="col-1"><p>Sorc Partizan</p></div>
            <div class="col-3">
                <img src="../images/odeca/sorc3.jpg" alt="">
            </div>
            <div class="col-1"><p>Sorc Crvena Zvezda</p></div>
        </div>
        <div class="row">
            <div class="col-3">
                <img src="../images/odeca/duks1.jpg" alt="">
            </div>
            <div class="col-1"><p>Duks Srbija</p></div>
            <div class="col-3">
                <img src="../images/odeca/duks2.jpg" alt="">
            </div>
            <div class="col-1"><p>Duks Partizan</p></div>
            <div class="col-3">
                <img src="../images/odeca/duks3.jpg" alt="">
            </div>
            <div class="col-1"><p>Duks Crvena Zvezda</p></div>
        </div>
    </div>
    <div class="recenzije">
        <h3>Recenzije:</h3>
